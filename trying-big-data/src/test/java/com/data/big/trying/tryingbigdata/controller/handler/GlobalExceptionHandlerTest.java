...
import com.data.big.trying.tryingbigdata.controller.TemperatureController;
...
public class GlobalExceptionHandlerTest {
    ...
    public void shouldReturnRightMessageWhenNoDataFound() throws Exception {
        when(service.processSearch(any(TemperatureSearchRequest.class))).thenThrow(new NoDataFound());
